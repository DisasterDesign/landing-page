...
export const ormatSections: ProposalSection[] = [
  {
    ...
    title: "מהחום שבאדמה — לסרט שמסביר את הטכנולוגיה",
    lead: "סרט טכנולוגי תלת-ממדי באורך כ-3 דקות שממחיש את ה-Ormat Energy Converter: מהמעמקים החמים, דרך הרתחת הנוזל האורגני והטורבינה המסתובבת, ועד החשמל הנקי לרשת — בשפה קולנועית ברמת חברות האנרגיה המובילות בעולם.",
  },
  {
    id: "about",
  ...
  },
  {
    ...
    points: [
      "סרט טכנולוגי 3D באורך ~3 דקות, כולל תסריט ו-Storyboard מאושר",
      "מידול ואנימציית 3D של מערך ה-OEC: באר, מאדה, טורבינה, גנרטור, מעבה אווירי, משאבות וצנרת",
      "חמישה פרקי נרטיב: פתיח · הבעיה · הטכנולוגיה · ההיקף · סגירת מותג",
      "קריינות מקצועית אחת (עברית או אנגלית), מוזיקה ועיצוב סאונד",
      "מסירה ב-4K + גרסת רשתות (16:9) — קובץ סופי אחד מאושר",
  ...
  },
  {
    id: "concept",
    station: "טורבינה",
    kicker: "03 · קונספט הסרטון",
    title: "המעגל הסגור — חמישה פרקים",
    lead: "הנרטיב נשען על מה ש-Ormat עושה אחרת: חום שכולם זורקים הופך לחשמל 24/7, והנוזל של כדור הארץ חוזר ישר פנימה.",
    points: [
      "0:00 הוק — מתחת לרגליים שלך מקור כוח שלא ישן",
      "0:20 הבעיה — סולארי נעצר בלילה; חום נמוך-דרגה מבוזבז",
      "0:45 הטכנולוגיה — הנוזל האורגני רותח, הטורבינה מסתובבת, הלולאה נסגרת",
      "1:50 ההיקף — אותו מנוע, שלושה מקורות חום; 190+ תחנות בעולם",
      "2:35 סגירת מותג — Always on · חלוצים מאז 1965",
    ],
  },
  {
    id: "showcase",
  ...
  },
  {
    ...
    points: [
      ...
      "עד 2 סבבי תיקונים בכל שלב; שינוי מעבר לתכולה = הזמנת שינוי בתשלום",
  ...
  },
  {
    ...
    lead: "לאורך הפרויקט אנחנו זמינים אליכם בלי ספירת שעות: תקשורת ישירה, פגישות Zoom, תיקונים והתייעצות — בימים א׳–ה׳ בין 9:00 ל-17:00, בתיאום מראש.",
  },
  {
    id: "price",
...
<div class="clause">
  ...
  <ul>
    ...
    <li>מסירה בפורמט 4K וכן גרסת רשתות (16:9) — קובץ סופי אחד מאושר.</li>
