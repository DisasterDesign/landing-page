...
export const PRICING_TIERS: PricingTier[] = [
  {
    ...
    currency: "₪",
    period: "חודש",
    tagline: "דף נחיתה ממוקד להמרה — אידיאלי לקמפיינים והשקות",
    cta: "בואו נדבר",
    sections: [
      {
        title: "עיצוב ובנייה",
    ...
    suitableFor: "קמפיינים ממומנים, השקות מוצר, מבצעים, לידים ממוקדים",
  },
  {
    id: "basic",
    name: "בסיס",
    ...
    currency: "₪",
    period: "חודש",
    tagline: "אתר תדמית נקי ומקצועי שמייצג את העסק ברמה גבוהה",
    cta: "בואו נדבר",
    sections: [
      {
        title: "עיצוב ובנייה",
  ...
  },
  {
    ...
    currency: "₪",
    period: "חודש",
    tagline: "אתר מושקע ומרשים עם חוויית משתמש ברמה גבוהה",
    cta: "בואו נדבר",
    recommended: true,
    sections: [
      {
    ...
    suitableFor: "מרפאות שיניים, קליניקות, משרדים מקצועיים, מותגים",
  },
  {
    id: "premium",
    name: "פרימיום",
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "עדכוני מערכת ותוספים",
          "ניטור תקלות",
          "תמיכה פרימיום — מענה מהיר בוואטסאפ",
          "עד 3 תיקונים / שינויים בחודש",
        ],
      },
    ],
    suitableFor: "חנויות, מסחר אלקטרוני, עסקים שרוצים מערכת מלאה",
  },
];
