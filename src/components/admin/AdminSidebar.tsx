...
const navItems = [
  ...
  {
    // מוכרים (/admin/sellers) is deliberately NOT a nav entry: it lists the
    // same people as שותפים, just filtered to commission rows. Two entries for
    // one group of people is how attribution questions got asked in two places.
    // The page and its API stay live, so existing links still resolve.
    label: "שותפים",
    href: "/admin/partners",
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
